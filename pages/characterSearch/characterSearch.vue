<template>
	<view class="character-search-container">
		<uni-notice-bar @close="hanldeNoticeClose" showClose showIcon scrollable v-if="isShowNotice"
			text="9.19 ban wave 我也被嘎了,想想还是继续维护吧, 用爱发电! 以后随缘维护了! 谢谢各位支持"></uni-notice-bar>
...
<script setup>
	...
	const noticeKey = "2023-11-01-notice"
